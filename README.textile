...
Colorize is similar to grep with --color option, except that it's more user friendly.
For people like me who don't want to remember XTerm color code, colorize can save you.
